...
class SingleLink(Link):
    def compute(self, cluster, other, distance_table, distance=None):
        ...
        # for isample in cluster.cluster_samples:
        #     for jsample in other.cluster_samples:
        #         if isample.s_id < jsample.s_id:
        #             computation = distance_table[isample.s_id][jsample.s_id]
        #         else:
        #             computation = distance_table[jsample.s_id][isample.s_id]
